 ...
 */
public final class TupleEight<A, B, C, D, E, F, G, H> extends Tuple implements One<A>, Two<B>, Three<C>, Four<D>, Five<E>, Six<F>, Seven<G>, Eight<H> {
    ...
    public TupleEight(final A value1, final B value2, final C value3, final D value4, final E value5, final F value6, final G value7, final H value8) {
